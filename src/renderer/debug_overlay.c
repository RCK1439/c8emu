...
C8DebugOverlay *c8CreateDebugOverlay(void)
{
    ...
    debugOverlay->debugTexts = C8_MALLOC(C8DebugText, INIT_CAPACITY);
    debugOverlay->size = 0;
...
static void c8DebugOverlayEnsureSpace(C8DebugOverlay *debugOverlay)
{
    ...
    debugOverlay->debugTexts = C8_REALLOC(C8DebugText, debugOverlay->debugTexts, debugOverlay->capacity);
}
